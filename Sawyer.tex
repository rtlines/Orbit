...
\TitleTop{Suppressor Optimization}
\TitleBottom{Bolt Velocity, Blow-back and Sound Output}
...
% Start regular page counting at page 1
	\mainmatter
    \doublespace
	\include{S3_introduction1}
	
	\include{S5_procedure}
	
	\include{S6_results}
	
	\include{S7_analysis}
	
	\include{S8_conclusion}
	...
	\include{S13_bibliography}
	
	
	\include{S10_ApendixA}
	\include{S11_ApendixB}
